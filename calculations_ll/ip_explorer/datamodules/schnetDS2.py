...
class SchNetDSDataModule(PLDataModuleWrapper):
    ...
    def setup(self, stage):
        ...
        # my way
        mydata = ASEAtomsData(datasetname, distance_unit='Ang')
        ...
        self.train_dataset  = mydata.subset(self.train_idx)
        self.test_dataset   = mydata.subset(self.test_idx)
        self.val_dataset    = mydata.subset(self.vaL_idx)
