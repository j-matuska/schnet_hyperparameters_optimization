...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 19 10:56:56 2023
...
def calculate_LSQM2(x: numpy.dtype(numpy.float64), y: numpy.dtype(numpy.float64)):
    """
    Calculate parameters of least square method
    ...
    R = float(result.rvalue)
    R2 = R*R
    slope_std=float(result.stderr)
    
    return slope, intercept, R2, slope_std
